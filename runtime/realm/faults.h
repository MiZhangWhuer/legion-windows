...
namespace Realm {
  ...
  class  CancellationException : public ExecutionException {
  public:
  ...
  class  PoisonedEventException : public ExecutionException {
  public:
  ...
  class  ApplicationException : public ExecutionException {
  public:
