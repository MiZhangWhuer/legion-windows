...
#undef DIMFUNC
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (req.verified)
        return (LegionErrorType)NO_ERROR;
...
#undef DIMFUNC
    ...
    //--------------------------------------------------------------------------
    {
      ...
      const size_t outstanding_count = 
        p_fetch_and_add(&outstanding_children_count,1);
    ...
    //--------------------------------------------------------------------------
    {
      ...
      p_fetch_and_add(&outstanding_children_count, unordered_ops.size());
      unordered_ops.clear();
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      // Take the context lock in exclusive mode
      {
        ...
        const int outstanding_count = 
          p_fetch_and_add(&outstanding_children_count, diff);
