                              ...
                              const std::set<Processor> &local_procs)
{
  ...
  legion_processor_t* local_procs_ = new legion_processor_t[local_procs.size()];
...
{
  Runtime *runtime = CObjectWrapper::unwrap(runtime_);
  Mapping::Mapper *mapper = CObjectWrapper::unwrap(mapper_);
...
{
  Mapping::Mapper::SliceTaskOutput* output = CObjectWrapper::unwrap(output_);
  Mapping::Mapper::TaskSlice slice = CObjectWrapper::unwrap(slice_);
...
{
    Mapping::Mapper::MapTaskOutput* output = CObjectWrapper::unwrap(output_);
