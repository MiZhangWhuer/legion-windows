...
namespace Legion {
  namespace Internal {
    ...
    REALM_THREAD_LOCAL LegionProfInstance *thread_local_profiling_instance = NULL;
   ...
   //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    {
      p_fetch_and_add(&total_outstanding_requests,cnt);
    }
    ...
    //--------------------------------------------------------------------------
    {
      unsigned prev = p_fetch_and_sub(&total_outstanding_requests,cnt);
#ifdef DEBUG_LEGION
      assert(prev >= cnt);
#endif
    ...
    //--------------------------------------------------------------------------
    {
      size_t footprint = p_fetch_and_add(&total_memory_footprint, diff);
...
#endif
#endif
          p_fetch_and_sub(&total_memory_footprint, diff);
#ifdef DEBUG_LEGION
