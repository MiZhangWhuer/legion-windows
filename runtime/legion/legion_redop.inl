...
namespace Legion {
  ...
  void SumReduction<bool>::apply<false>(LHS &lhs, RHS rhs)
  {
    ...
    } while (!p_atomic_cmpxchg((int64_t *)target, oldval.as_int, newval.as_int));
#endif
  }
...
#undef CASE
  ...
  void SumReduction<__half>::apply<false>(LHS &lhs, RHS rhs)
  {
    ...
    } while (!p_atomic_cmpxchg(target, oldval.as_int, newval.as_int));
#endif
  }
  ...
  void SumReduction<complex<__half> >::apply<false>(LHS &lhs, RHS rhs)
  {
    ...
    } while (!p_atomic_cmpxchg(target, oldval, newval));
#endif
  }
