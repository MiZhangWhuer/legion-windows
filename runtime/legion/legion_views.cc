...
namespace Legion {
  namespace Internal {
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (!subviews.empty() && !(subviews.get_valid_mask() * subview_mask))
      {
        ...
        if (!dominating_subviews.empty())
        {
          ...
          {
            FieldMaskSet<ExprView>::iterator first = 
    ...
    //--------------------------------------------------------------------------
    {
      ...
      FieldMaskSet<ExprView>::iterator finder = clean_set.find(this);
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
        for (EventUsers::iterator it = current_finder->second.begin();
      ...
      {
        for (EventUsers::iterator it = previous_finder->second.begin();
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (user_expr != current_users->view_expr)
      {
        ...
        p_fetch_and_add(&outstanding_additions,1);
      }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (event_finder != outstanding_gc_events.end())
      {
        ...
        {
          for (EventUsers::iterator it = finder->second.begin();
